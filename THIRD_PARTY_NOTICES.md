...
repository redistributes of each. The rest is fetched from upstream by `setup/download.sh` or
obtained by the user. Each patch under `submodules_patches/` is a diff against one of these
projects, and its header names that project's licence.
...
| [100DoH detector](https://github.com/ddshan/hand_object_detector) | MIT | none stated | Patch, weights mirror |
...
| [Detectron2](https://github.com/facebookresearch/detectron2) ViTDet-H | Apache-2.0 | CC BY-SA 3.0 | Patch |
| [SAM 2](https://github.com/facebookresearch/sam2) | Apache-2.0 | Apache-2.0 | Patch |
...
| [PyRoKi](https://github.com/chungmin99/pyroki), [jaxls](https://github.com/brentyi/jaxls) | MIT | — | No |
